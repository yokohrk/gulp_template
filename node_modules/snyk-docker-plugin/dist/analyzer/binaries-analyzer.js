...
function analyze(targetImage, installedPackages, pkgManager) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var binaries;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getBinaries(targetImage, installedPackages, pkgManager)];
                case 1:
                    binaries = _a.sent();
                    return [2 /*return*/, {
                            Image: targetImage,
...
function getBinaries(targetImage, installedPackages, pkgManager) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {

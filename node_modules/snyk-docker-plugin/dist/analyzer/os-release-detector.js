...
function detect(targetImage) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    docker = new docker_1.Docker(targetImage);
...
function tryOSRelease(docker) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, docker.catSafe('/etc/os-release')];
                case 1:
                    text = _a.sent();
                    if (!text) {
...
function tryLSBRelease(docker) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, docker.catSafe('/etc/lsb-release')];
                case 1:
                    text = _a.sent();
                    if (!text) {
                        return [2 /*return*/, null];
...
function tryDebianVersion(docker) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, docker.catSafe('/etc/debian_version')];
                case 1:
                    text = _a.sent();
                    if (!text) {
                        return [2 /*return*/, null];
...
function tryAlpineRelease(docker) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, docker.catSafe('/etc/alpine-release')];
                case 1:
                    text = _a.sent();
                    if (!text) {
                        return [2 /*return*/, null];
...
function tryRedHatRelease(docker) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, docker.catSafe('/etc/redhat-release')];
                case 1:
                    text = _a.sent();
                    if (!text) {
                        return [2 /*return*/, null];
...
function tryOracleRelease(docker) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, docker.catSafe('/etc/oracle-release')];
                case 1:
                    text = _a.sent();
                    if (!text) {
                        return [2 /*return*/, null];
